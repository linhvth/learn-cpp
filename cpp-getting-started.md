...
![C/C++ extension in Visual Studio Code](https://github.com/linhvth/learn-cpp\images\cpp-extension-vsc.png)
...
The code block below shows how we can print "Hello World!" in C++
